...
class RessourcesEauxPage extends StatefulWidget {
  const RessourcesEauxPage({Key? key}) : super(key: key);

  @override
  State<RessourcesEauxPage> createState() => _RessourcesEauxPageState();
}

class _RessourcesEauxPageState extends State<RessourcesEauxPage> {
  @override
  void initState() {
    super.initState();
  }
                        ...
                        Stack(
                          children: [
                            ...
                            const Positioned(
                              ...
                              child: Center(
                                child: Text(
                                  "Ressources eaux et maritimes (E3)",
