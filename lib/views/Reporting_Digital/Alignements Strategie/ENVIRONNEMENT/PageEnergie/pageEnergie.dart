...
import 'package:performence_esg/views/Reporting_Digital/Alignements%20Strategie/ENVIRONNEMENT/PageEnergie/ligneMenuEnergie.dart';
...
class EnergiePage extends StatefulWidget {
  const EnergiePage({Key? key}) : super(key: key);

  @override
  State<EnergiePage> createState() => _EnergiePageState();
}

class _EnergiePageState extends State<EnergiePage> {
  @override
  void initState() {
    super.initState();
  }
