...
class RessourcesEconomiePage extends StatefulWidget {
  const RessourcesEconomiePage({Key? key}) : super(key: key);

  @override
  State<RessourcesEconomiePage> createState() => _RessourcesEconomiePageState();
}

class _RessourcesEconomiePageState extends State<RessourcesEconomiePage> {
  @override
  void initState() {
    super.initState();
  }
                        ...
                        Stack(
                          children: [
                            ...
                            const Positioned(
                              ...
                              child: Center(
                                child: Text(
                                  "Ressources et economie circulaire (E5)",
