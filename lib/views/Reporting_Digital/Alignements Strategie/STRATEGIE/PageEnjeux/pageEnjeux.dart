...
class EnjeuxPage extends StatefulWidget {
  const EnjeuxPage({Key? key}) : super(key: key);

  @override
  State<EnjeuxPage> createState() => _EnjeuxPageState();
}

class _EnjeuxPageState extends State<EnjeuxPage> {
  @override
  void initState() {
    super.initState();
  }
                        ...
                        Stack(
                          children: [
                            ...
                            const Positioned(
                              ...
                              child: Center(
                                child: Text(
                                  "Enjeux materiels et alignement strategique (G1)",
