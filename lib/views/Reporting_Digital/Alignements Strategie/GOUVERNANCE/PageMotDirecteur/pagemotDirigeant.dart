...
class MotDuDirigeantPage extends StatefulWidget {
  const MotDuDirigeantPage({Key? key}) : super(key: key);

  @override
  State<MotDuDirigeantPage> createState() => _MotDuDirigeantPageState();
}

class _MotDuDirigeantPageState extends State<MotDuDirigeantPage> {
  @override
  void initState() {
    super.initState();
  }
