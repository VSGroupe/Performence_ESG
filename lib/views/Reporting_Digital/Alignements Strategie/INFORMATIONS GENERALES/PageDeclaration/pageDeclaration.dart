...
class DeclarationDeConformitePage extends StatefulWidget {
  const DeclarationDeConformitePage({Key? key}) : super(key: key);

  @override
  State<DeclarationDeConformitePage> createState() =>
      _DeclarationDeConformitePageState();
}

class _DeclarationDeConformitePageState
    extends State<DeclarationDeConformitePage> {
  @override
  void initState() {
    super.initState();
  }
