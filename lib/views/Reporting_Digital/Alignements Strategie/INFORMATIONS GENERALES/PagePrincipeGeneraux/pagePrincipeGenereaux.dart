...
class PrincipeGenereauxPage extends StatefulWidget {
  const PrincipeGenereauxPage({Key? key}) : super(key: key);

  @override
  State<PrincipeGenereauxPage> createState() => _PrincipeGenereauxPageState();
}

class _PrincipeGenereauxPageState extends State<PrincipeGenereauxPage> {
  @override
  void initState() {
    super.initState();
  }
