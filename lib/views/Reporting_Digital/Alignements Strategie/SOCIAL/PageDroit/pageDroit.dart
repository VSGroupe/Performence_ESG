...
class DroitPage extends StatefulWidget {
  const DroitPage({Key? key}) : super(key: key);

  @override
  State<DroitPage> createState() => _DroitPageState();
}

class _DroitPageState extends State<DroitPage> {
  @override
  void initState() {
    super.initState();
  }
                        ...
                        Stack(
                          children: [
                            ...
                            const Positioned(
                              ...
                              child: Center(
                                child: Text(
                                  "Droit des humains, due diligences ",
