...
class EthiqueConformitePage extends StatefulWidget {
  const EthiqueConformitePage({Key? key}) : super(key: key);

  @override
  State<EthiqueConformitePage> createState() => _EthiqueConformitePageState();
}

class _EthiqueConformitePageState extends State<EthiqueConformitePage> {
  @override
  void initState() {
    super.initState();
  }
                        ...
                        Stack(
                          children: [
                            ...
                            const Positioned(
                              ...
                              child: Center(
                                child: Text(
                                  "Ethique, conformités, DueDiligence",
