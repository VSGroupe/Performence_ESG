...
class VisionMissionPages extends StatefulWidget {
  const VisionMissionPages({Key? key}) : super(key: key);

  @override
  State<VisionMissionPages> createState() => _VisionMissionPagesState();
}

class _VisionMissionPagesState extends State<VisionMissionPages> {
  @override
  void initState() {
    super.initState();
  }
                        ...
                        Stack(
                          children: [
                            ...
                            const Positioned(
                              ...
                              child: Center(
                                child: Text(
                                  "Visions, Missions et validations",
