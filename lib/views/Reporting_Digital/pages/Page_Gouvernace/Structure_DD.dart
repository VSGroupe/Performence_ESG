...
class StructureDDPage extends StatefulWidget {
  const StructureDDPage({Key? key}) : super(key: key);

  @override
  State<StructureDDPage> createState() => _StructureDDPageState();
}

class _StructureDDPageState extends State<StructureDDPage> {
  @override
  void initState() {
    super.initState();
  }
