...
class AdhesionInitiativePage extends StatefulWidget {
  const AdhesionInitiativePage({Key? key}) : super(key: key);

  @override
  State<AdhesionInitiativePage> createState() => _AdhesionInitiativePageState();
}

class _AdhesionInitiativePageState extends State<AdhesionInitiativePage> {
  @override
  void initState() {
    super.initState();
  }
                        ...
                        Stack(
                          children: [
                            ...
                            const Positioned(
                              ...
                              child: Center(
                                child: Text(
                                  "Adhesions, initiatives volontaire et influences des réseaux",
