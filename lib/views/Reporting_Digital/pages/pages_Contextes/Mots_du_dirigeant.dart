...
class MotsDuDirigeantPage extends StatefulWidget {
  const MotsDuDirigeantPage({Key? key}) : super(key: key);

  @override
  State<MotsDuDirigeantPage> createState() => _MotsDuDirigeantPageState();
}

class _MotsDuDirigeantPageState extends State<MotsDuDirigeantPage> {
  @override
  void initState() {
    super.initState();
  }
