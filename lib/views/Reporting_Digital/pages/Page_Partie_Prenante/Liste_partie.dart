...
class ListePartiePages extends StatefulWidget {
  const ListePartiePages({Key? key}) : super(key: key);

  @override
  State<ListePartiePages> createState() => _ListePartiePagesState();
}

class _ListePartiePagesState extends State<ListePartiePages> {
  @override
  void initState() {
    super.initState();
  }
                        ...
                        Stack(
                          children: [
                            ...
                            const Positioned(
                              ...
                              child: Center(
                                child: Text(
                                  "Listes des parties prenanteset attentes",
